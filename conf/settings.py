...
SECRET_KEY = '8sjkg2hj3+6en5i&@c6u_5@%1flkj^8eu=5=7)6q=0_i0*q5)u'
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'final-project-thelukerussell.herokuapp.com'
]
...
SPOTIFY_AUTH_KEY = os.environ['SPOTIFY_AUTH_KEY']
SPOTIFY_AUTH_SECRET = os.environ['SPOTIFY_AUTH_SECRET']
