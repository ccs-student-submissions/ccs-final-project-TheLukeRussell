...
class BandRegistration extends Component  {
    state = {
        username: '',
        email: '',
        password1: '',
    ...
    handleSubmit = (e) => {
        ...
        .then(res => {
            ...
            this.props.history.push('/band-create/');
        })
        .catch(error => {
            console.log(error);
        });
        ...
        return(
            ...
            <div className='login col-md-2'>
                    ...
                    <form onSubmit={this.handleSubmit} method='post'>
                        <label htmlFor="username">Band Username</label><br/>
                        ...
                        <label htmlFor="email">Band Email</label><br/>
